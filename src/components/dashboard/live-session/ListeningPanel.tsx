...
export function ListeningPanel() {
  ...
  return (
    <div className="relative bg-gradient-to-b from-[#2a0a0f] to-[#1a0507] rounded-2xl p-6 shadow-2xl flex flex-col items-center justify-center overflow-hidden border border-bm-gold/20 flex-grow min-h-[300px]">
      ...
      <div className="absolute top-6 left-6 flex items-center gap-2 z-10">
        <span className="relative flex h-3 w-3">
          ...
          <span className="relative inline-flex rounded-full h-3 w-3 bg-feedback-positive"></span>
        </span>
        <span className="text-white/80 text-xs font-semibold tracking-wider uppercase">Listening</span>
      </div>
      <div className="flex items-center justify-center gap-1.5 h-32 w-full z-10 px-4">
      ...
      <div className="mt-8 z-10 relative group">
        ...
        <button className="relative w-20 h-20 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full flex items-center justify-center text-white hover:scale-105 transition-all duration-300 shadow-glow">
          <span className="material-symbols-outlined text-4xl">mic</span>
        </button>
      </div>
      <p className="mt-6 text-bm-white/60 text-sm font-medium z-10">Speak clearly to continue...</p>
    </div>
  )
}
