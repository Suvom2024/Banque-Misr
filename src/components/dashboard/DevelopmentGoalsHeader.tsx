...
interface DevelopmentGoalsHeaderProps {
  userName: string
  userRole?: string
  userAvatar?: string
}

export function DevelopmentGoalsHeader({ userName, userRole = 'Branch Manager', userAvatar }: DevelopmentGoalsHeaderProps) {
  return (
      ...
      <div className="w-full px-4 lg:px-6">
        <div className="flex items-center justify-between h-16">
          <div className="flex flex-col justify-center flex-shrink-0 min-w-0 max-w-[40%]">
            ...
            <h1 className="text-base lg:text-lg font-bold text-bm-maroon tracking-tight leading-tight truncate">My Development Goals</h1>
          </div>
          <div className="flex items-center gap-2 lg:gap-4 flex-shrink-0">
            <div className="flex gap-1.5 lg:gap-2">
              <button className="flex items-center gap-1 px-2 lg:px-2.5 py-1.5 rounded-md border border-bm-grey text-bm-text-secondary hover:text-bm-maroon hover:border-bm-maroon transition-all text-[11px] lg:text-xs font-semibold bg-white whitespace-nowrap">
                <span className="material-symbols-outlined text-sm lg:text-base">history</span>
                <span className="hidden sm:inline">History</span>
              </button>
              <button className="flex items-center gap-1 px-2 lg:px-2.5 py-1.5 rounded-md border border-bm-grey text-bm-text-secondary hover:text-bm-maroon hover:border-bm-maroon transition-all text-[11px] lg:text-xs font-semibold bg-white whitespace-nowrap">
                <span className="material-symbols-outlined text-sm lg:text-base">download</span>
