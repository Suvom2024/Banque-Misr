...
export function IntegrationsHeader({ userName, userRole = 'Branch Manager', userAvatar }: IntegrationsHeaderProps) {
  return (
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0 min-w-0 max-w-[50%]">
            <div className="flex items-center gap-1.5 text-[10px] lg:text-xs text-bm-text-subtle mb-0.5">
              ...
              <span className="text-bm-maroon font-semibold">Integrations</span>
            </div>
            <h1 className="text-base lg:text-lg font-bold text-bm-maroon tracking-tight leading-tight truncate">Integrations & Connected Services</h1>
          </div>
