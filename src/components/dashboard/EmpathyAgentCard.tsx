...
export function EmpathyAgentCard({ score, findings, recommendation, empathyChart }: EmpathyAgentCardProps) {
  return (
    <div className="bg-bm-white rounded-xl shadow-card border border-bm-grey/60 overflow-hidden hover:shadow-card-hover transition-all">
      <div className="border-l-[6px] border-l-bm-gold p-5">
        <div className="flex justify-between items-start mb-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h4 className="font-semibold text-sm text-bm-text-primary">Empathy Agent</h4>
              <p className="text-[10px] text-bm-text-secondary">Tone & Sentiment Analysis</p>
            </div>
          </div>
          <span className="inline-flex items-center rounded-md bg-yellow-50 px-2 py-0.5 text-[10px] font-medium text-yellow-800 ring-1 ring-inset ring-yellow-600/20">
            Score: {score}/100
          </span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="flex flex-col justify-end">
            <h5 className="text-[10px] font-bold text-bm-text-subtle uppercase mb-2">Empathy Over Session</h5>
            <div className="h-20 w-full flex items-end justify-between gap-1 pb-2 border-b border-bm-grey">
            ...
            <div className="flex justify-between text-[9px] text-bm-text-subtle mt-1">
              <span>Start</span>
              <span>Middle</span>
              <span>End</span>
            </div>
